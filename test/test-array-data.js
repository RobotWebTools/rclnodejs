    ...
    [
      {
        ...
        values: [
          ...
          {
            layout: layout,
            data: Int8Array.from([-10, 1, 2, 3, 8, 6, 0, -25]),
      ...
      },
      {
        ...
        values: [
          ...
          {
            layout: layout,
            data: Int16Array.from([-10, 1, 2, 3, 8, 6, 0, -25]),
          }, // Provide data via TypedArray
        ],
      },
      {
      ...
      },
      {
        ...
        values: [
          ...
          {
            layout: layout,
            data: Uint16Array.from([0, 1, 2, 3, 8, 6, 0, 255]),
          }, // Provide data via TypedArray
        ],
      },
      {
        ...
        values: [
          ...
          {
            layout: layout,
            data: Uint32Array.from([0, 1, 2, 3, 8, 6, 0, 255]),
          }, // Provide data via TypedArray
        ],
      },
      {
