...
RUN wget https://github.com/ros2/ros2/releases/download/release-foxy-20200710/ros2-foxy-20200710-linux-focal-amd64.tar.bz2 \
    && tar xf ros2-foxy-20200710-linux-focal-amd64.tar.bz2
