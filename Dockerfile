...
RUN wget https://github.com/ros2/ros2/releases/download/release-bouncy/ros2-bouncy-linux-xenial-x86_64.tar.bz2 \
    && tar xf ros2-bouncy-linux-xenial-x86_64.tar.bz2
