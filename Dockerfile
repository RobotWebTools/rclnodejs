...
RUN wget https://github.com/ros2/ros2/releases/download/release-galactic-20210523/ros2-galactic-20210523-linux-focal-amd64.tar.bz2 \
    && tar xf ros2-galactic-20210523-linux-focal-amd64.tar.bz2
