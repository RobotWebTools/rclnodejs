...
RUN wget https://github.com/ros2/ros2/releases/download/release-foxy-20201009/ros2-foxy-20201009-linux-focal-amd64.tar.bz2 \
    && tar xf ros2-foxy-20201009-linux-focal-amd64.tar.bz2
