...
class ShadowNode : public Napi::ObjectWrap<ShadowNode>, public Executor::Delegate {
 public:
 ...
 private:
  ...
  static Napi::Value SyncHandles(const Napi::CallbackInfo& info);
  static Napi::Value SpinOnce(const Napi::CallbackInfo& info);
  static Napi::Value HandleGetter(const Napi::CallbackInfo& info);
  static void HandleSetter(const Napi::CallbackInfo& info, const Napi::Value& value);
