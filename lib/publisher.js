...
class Publisher extends Entity {
   ...
   * @param {boolean} enabled - Whether to validate messages before publishing
  ...
  setValidation(enabled, options = {}) {
    this._validateMessages = enabled;
  ...
  /**
   * Check if message validation is enabled for this publisher
