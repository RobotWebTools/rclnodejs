...
import { TypeValidationError, NameValidationError } from './errors.js';
...
// Named export for the one method imported directly elsewhere (e.g. node.js).
// Bound to the validator object so it works when called as a free function.
export const validateFullTopicName =
  validator.validateFullTopicName.bind(validator);
