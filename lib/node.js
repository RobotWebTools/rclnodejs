  ...
  execute(handles) {
    ...
    subscriptionsReady.forEach((subscription) => {
      if (subscription.isRaw) {
        let rawMessage = !subscription.isDestroyed()
          ? rclnodejs.rclTakeRaw(subscription.handle)
          : undefined;
        if (rawMessage) {
      ...
      this._runWithMessageType(
        ...
        (message, deserialize) => {
          let success = !subscription.isDestroyed()
            ? rclnodejs.rclTake(subscription.handle, message)
            : undefined;
          if (success) {
    ...
    clientsReady.forEach((client) => {
      this._runWithMessageType(
        ...
        (message, deserialize) => {
          let sequenceNumber = !client.isDestroyed()
            ? rclnodejs.rclTakeResponse(client.handle, message)
            : undefined;
    ...
    servicesReady.forEach((service) => {
      this._runWithMessageType(
        ...
        (message, deserialize) => {
          let header = !service.isDestroyed()
            ? rclnodejs.rclTakeRequest(service.handle, this.handle, message)
            : undefined;
          if (header) {
    ...
    actionClientsReady.forEach((actionClient) => {
      ...
      if (properties.isGoalResponseReady) {
        this._runWithMessageType(
          ...
          (message, deserialize) => {
            let sequence = !actionClient.isDestroyed()
              ? rclnodejs.actionTakeGoalResponse(actionClient.handle, message)
              : undefined;
      ...
      if (properties.isCancelResponseReady) {
        this._runWithMessageType(
          ...
          (message, deserialize) => {
            let sequence = !actionClient.isDestroyed()
              ? rclnodejs.actionTakeCancelResponse(actionClient.handle, message)
              : undefined;
            if (sequence != undefined) {
      ...
      if (properties.isResultResponseReady) {
        this._runWithMessageType(
          ...
          (message, deserialize) => {
            let sequence = !actionClient.isDestroyed()
              ? rclnodejs.actionTakeResultResponse(actionClient.handle, message)
              : undefined;
            if (sequence != undefined) {
      ...
      if (properties.isFeedbackReady) {
        this._runWithMessageType(
          ...
          (message, deserialize) => {
            let success = !actionClient.isDestroyed()
              ? rclnodejs.actionTakeFeedback(actionClient.handle, message)
              : undefined;
            if (success) {
      ...
      if (properties.isStatusReady) {
        this._runWithMessageType(
          ...
          (message, deserialize) => {
            let success = !actionClient.isDestroyed()
              ? rclnodejs.actionTakeStatus(actionClient.handle, message)
              : undefined;
            if (success) {
    ...
    actionServersReady.forEach((actionServer) => {
      ...
      if (properties.isGoalRequestReady) {
        this._runWithMessageType(
          ...
          (message, deserialize) => {
            const result = !actionServer.isDestroyed()
              ? rclnodejs.actionTakeGoalRequest(actionServer.handle, message)
              : undefined;
            if (result) {
      ...
      if (properties.isCancelRequestReady) {
        this._runWithMessageType(
          ...
          (message, deserialize) => {
            const result = !actionServer.isDestroyed()
              ? rclnodejs.actionTakeCancelRequest(actionServer.handle, message)
              : undefined;
            if (result) {
      ...
      if (properties.isResultRequestReady) {
        this._runWithMessageType(
          ...
          (message, deserialize) => {
            const result = !actionServer.isDestroyed()
              ? rclnodejs.actionTakeResultRequest(actionServer.handle, message)
              : undefined;
            if (result) {
