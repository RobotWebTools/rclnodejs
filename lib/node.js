...
class Node {
  ...
  /**
   * Create a Publisher.
   * @param {function|string} typeClass - The class or a string representing the message. e.g. 'std_msgs/msg/String'
   * @param {string} topic - The name of the topic.
   * @param {QoS} [qos=QoS.profileDefault] - ROS Middleware "quality of service" settings for the publisher.
   * @return {Publisher} - An instance of Publisher.
   */
  createPublisher(typeClass, topic, qos = QoS.profileDefault) {
    if (typeof (typeClass) === 'string') {
      // Also take in string parameter, e.g. 'std_msgs/msg/String'
   ...
   * @param {QoS} [qos=QoS.profileDefault] - ROS Middleware "quality of service" settings for the subscription.
   ...
   * @param {QoS} [qos=QoS.profileDefault] - ROS Middleware "quality of service" settings for the client.
   ...
   * @param {Object} responseTempl - The template object of the response to client(caller)
   * @return {Object} A reponse object (use param responseTempl as a template object)
   ...
   * @param {QoS} [qos=QoS.profileDefault] - ROS Middleware "quality of service" settings for the service.
