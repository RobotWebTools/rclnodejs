...
class Node {
   ...
   * @param {function} typeClass - The class representing the message.
   * @param {string} topic - The name of the topic.
   * @param {function} callback - The callback to be call when receiving the topic subscribed.
   ...
   * @param {function} callback - The callback to be called when receiving request.
   * @return {Client} - An instance of Service.
   */
  ...
  /**
   * Destory all resource allocated by this node, including timers/publishers/subscriptions/clients/services.
   * @return {undefined}
   */
  destory() {
    this.stopSpin();
