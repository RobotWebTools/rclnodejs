...
export {
  ...
  ensureDir,
  ensureDir as mkdirs, // Alias for fs-extra compatibility
  pathExists as exists, // Renamed to avoid conflict with deprecated fs.exists
  pathExists,
  emptyDir,
  copy,
  remove,
  ...
  ensureDirSync,
  ensureDirSync as mkdirSync, // Alias for fs-extra compatibility
  removeSync,
  readJsonSync,
  compareVersions,
};
