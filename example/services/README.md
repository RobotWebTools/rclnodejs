...
#### Service Server (`service/service-example.mjs`)
...
- **Run Command**: `node example/services/service/service-example.mjs`

#### Service Client (`client/client-example.mjs`)
...
- **Run Command**: `node example/services/client/client-example.mjs`

#### Async Service Client (`client/async-client-example.mjs`)
...
- **Run Command**: `node example/services/client/async-client-example.mjs`

#### Service Client Validation (`client/client-validation-example.mjs`)
...
- **Run Command**: `node example/services/client/client-validation-example.mjs`
...
#### Service Server (`service/getmap-service-example.mjs`)
...
- **Run Command**: `node example/services/service/getmap-service-example.mjs`

#### Service Client (`client/getmap-client-example.mjs`)
...
- **Run Command**: `node example/services/client/getmap-client-example.mjs`
...
3. **Start the Client**: In another terminal, run:
   ...
   ```bash
   cd /path/to/rclnodejs
   node example/services/client/client-example.mjs
   ```
...
3. **Start the Async Client**: In another terminal, run:
   ...
   ```bash
   cd /path/to/rclnodejs
   node example/services/client/async-client-example.mjs
   ```
...
2. **Start the GetMap Service Server**: In one terminal, run:
   ...
   ```bash
   cd /path/to/rclnodejs
   node example/services/service/getmap-service-example.mjs
   ```
...
3. **Start the GetMap Client**: In another terminal, run:
   ...
   ```bash
   cd /path/to/rclnodejs
   node example/services/client/getmap-client-example.mjs
   ```
