...
mkdir -p $MODULEDIR
rsync -a . $MODULEDIR --exclude build --exclude dist --exclude node_modules --exclude generated --exclude circle.yml --exclude Dockerfile --exclude appveyor.yml --exclude .travis.yml --exclude .coveralls.yml --exclude .istanbul.yml
