...
>>>>>>> ec73bb4 Improve UX of msg generation process & README doc
...
the `generate-ros-messages` commandline script that reads in the IDL 
...
To use `generate-ros-messages` from your Nodejs package, create an npm 
