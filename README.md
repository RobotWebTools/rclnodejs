# rclnodejs - ROS Client Library for JavaScript language[![Coverage Status](https://coveralls.io/repos/github/RobotWebTools/rclnodejs/badge.svg)](https://coveralls.io/github/RobotWebTools/rclnodejs)
